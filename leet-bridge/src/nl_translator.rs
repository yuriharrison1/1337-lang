...
//!
//! Axis layout (v0.5.1):
//!   Block S [0-7]:   ESSENCE, CORRESPONDENCE, VIBRATION, POLARITY,
//!                    RHYTHM, CAUSE_EFFECT, GENERATIVITY, SYSTEM
//!   Block D [8-15]:  STATE, PROCESS, RELATION, SIGNAL,
//!                    STABILITY, ONTOLOGICAL_VALENCE, CAUSALITY, VERIFIABILITY
//!   Block G [16-23]: TEMPORALITY, TEMPORAL_ANCHOR, COMPLETENESS, REVERSIBILITY,
//!                    COGNITIVE_LOAD, ORIGIN, EPISTEMIC_VALENCE, URGENCY
//!   Block P [24-31]: IMPACT, VALUE, ANOMALY, AFFECT,
//!                    DEPENDENCY, TEMPORAL_VECTOR, ACTION, ACTION_VALENCE
